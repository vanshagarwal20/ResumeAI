...
public class RedisConfig implements CachingConfigurer {
    ...
    public CacheManager cacheManager(RedisConnectionFactory factory) {
        ...
        RedisCacheConfiguration defaultConfig = RedisCacheConfiguration.defaultCacheConfig()
            .entryTtl(Duration.ofMinutes(5))   // resumes: 5 min TTL (user edits often)
            .serializeKeysWith(
        ...
        cacheConfigs.put("resumes", defaultConfig.entryTtl(Duration.ofMinutes(5)));
        cacheConfigs.put("resumeList", defaultConfig.entryTtl(Duration.ofMinutes(5)));
     ...
     * The method will fall through to the database as if caching was disabled.
     */
    @Override
